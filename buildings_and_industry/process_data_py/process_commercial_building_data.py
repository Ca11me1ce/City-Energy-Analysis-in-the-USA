...
#     Title:          Process commecial building energy data
#     Command:        $python 
# ##################################################################
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    # Open JSON file
    # Please unzip activities_commercial_json.zip to obain the JSON file
    f_json=open_file('../data_in_json/activities_commercial.json', 'r')
    ...
    f_csv=open('../data_in_csv/commercial_building_backup.csv', 'w', newline='') 
