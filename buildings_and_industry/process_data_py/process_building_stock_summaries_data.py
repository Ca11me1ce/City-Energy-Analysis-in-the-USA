...
#     Title:          Process building stock summaries data
#     Command:        $python 
# ##################################################################
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    # Open JSON file
    # Please unzip building_stock_summaries_json.zip to obain the JSON file
    f_json=open_file('../data_in_json/building_stock_summaries.json', 'r')
    ...
    f_csv=open('../data_in_csv/building_stock_summaries.csv', 'w', newline='') 
